...
<div class="max-w-none">
  <section>
    <p class="mb-2 font-semibold uppercase tracking-wide text-text-muted">Pháp Môn Tịnh Độ</p>

    <div class="rounded-2xl border border-brand-primary/20 bg-brand-primary/5 p-5 mb-8 text-center">
      <h2 class="mt-0 mb-4 text-2xl md:text-3xl font-bold text-brand-accent uppercase leading-snug">NHẬN THỨC VỀ NHÂN QUẢ VÀ NGHIỆP</h2>
      <div class="h-1 w-20 bg-brand-primary mx-auto my-4 rounded-full"></div>
      <p class="mb-0 text-lg font-medium opacity-80">Tóm lược bài giảng của</p>
      <p class="mt-1 mb-0 text-xl font-bold text-text-primary">Cố HT. Thích Giác Khang</p>
    </div>

    <div class="bg-brand-primary/5 p-4 rounded-lg border border-brand-primary/20 mb-8 italic">
    ...
    <h2 id="dan-nhap" class="text-2xl font-bold text-brand-accent mt-10 border-b-2 border-brand-primary/20 pb-2">I. DẪN NHẬP: KHÁI NIỆM TÂM, NHÂN QUẢ VÀ NGHIỆP</h2>
    ...
    <p class="font-semibold text-brand-accent">Đặt vấn đề: Vậy thì Nhân quả là sao? Nghiệp là như thế nào? Nhân quả và Nghiệp giống nhau hay khác nhau?</p>

    <div class="my-10 border-t border-dashed border-brand-primary/30 opacity-50 w-2/3 mx-auto"></div>

    <h2 id="dinh-nghia" class="text-2xl font-bold text-brand-accent mt-10 border-b-2 border-brand-primary/20 pb-2">II. ĐỊNH NGHĨA VÀ MỐI QUAN HỆ GIỮA NHÂN QUẢ VÀ NGHIỆP</h2>
    
    <div class="mt-6 space-y-6">
      <div>
        <h3 class="text-xl font-bold text-brand-accent mb-2 border-l-4 border-brand-primary pl-3">1. Phân loại Nhân quả</h3>
        <ul class="space-y-3 pl-0 list-none" style="list-style-type: none;">
          <li class="bg-brand-primary/5 p-4 rounded-lg border border-brand-primary/20">
      ...
      <div>
        <h3 class="text-xl font-bold text-brand-accent mb-2 border-l-4 border-brand-primary pl-3">2. Định nghĩa Nghiệp</h3>
      ...
      <div>
        <h3 class="text-xl font-bold text-brand-accent mb-2 border-l-4 border-brand-primary pl-3">3. Mối quan hệ giữa Nhân quả và Nghiệp</h3>
        <ul class="list-disc pl-5 space-y-2">
          ...
          <li>
            ...
            <ul class="pl-5 mt-1 space-y-1" style="list-style-type: circle;">
    ...
    <h2 id="gia-tri-than-nguoi" class="text-2xl font-bold text-brand-accent mt-10 border-b-2 border-brand-primary/20 pb-2">III. GIÁ TRỊ CỦA THÂN NGƯỜI VÀ KHẢ NĂNG CHUYỂN NGHIỆP</h2>
    ...
    <p class="font-bold text-brand-accent mt-4 text-lg">Đức Phật có nói: "Được làm người rất quý" vì con người có ý chí biết cải sửa nhân quả thành nghiệp, chuyển nghiệp ác thành thiện cho đến thuần thiện, nếu đủ duyên sẽ dứt nghiệp.</p>

    <div class="bg-brand-primary/5 p-4 rounded-xl border border-brand-primary/20 mt-4">
      <h4 class="font-bold text-brand-accent mb-2">Nguyên lý chuyển nghiệp trong hiện tại:</h4>
    ...
    <h2 id="phan-tich-nhan-qua" class="text-2xl font-bold text-brand-accent mt-10 border-b-2 border-brand-primary/20 pb-2">IV. PHÂN TÍCH NHÂN QUẢ VÀ NGHIỆP QUA 15 HẠNG CHÚNG SANH</h2>
    ...
    <div class="pl-4 border-l-2 border-brand-primary/30 mb-6 italic opacity-90">
    ...
    <!-- CÕI DỤC GIỚI -->
    <h3 class="text-xl font-bold text-brand-accent mt-8 mb-4 bg-brand-primary/5 inline-block px-4 py-1 rounded-lg">A. CÕI DỤC GIỚI</h3>
    ...
    <div class="space-y-6">
      <div>
        <h4 class="font-bold text-lg text-text-secondary">1. Bốn đường ác (Địa ngục, Ngạ quỷ, Súc sanh, A-tu-la)</h4>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
          <div class="bg-brand-primary/5 p-3 rounded-lg border border-brand-primary/20">
            <p class="font-bold text-brand-accent mb-1">Hành vi:</p>
          ...
          <div class="bg-brand-primary/5 p-3 rounded-lg border border-brand-primary/20">
            <p class="font-bold text-brand-accent mb-1">Biểu hiện tâm lý:</p>
            <ul class="list-disc pl-4 space-y-1">
      ...
      <div>
        <h4 class="font-bold text-lg text-text-secondary">2. Loài Người</h4>
        ...
        <div class="space-y-4 mt-2">
          <div class="border-l-4 border-brand-accent pl-4 py-2">
            <p class="font-bold text-brand-accent">Trường hợp A: Trong môi trường KHÔNG luân lý</p>
            <p class="mb-2">Dễ bị dục vọng chi phối mạnh, ý chí đồng hóa với tâm ác và hành động tạo nghiệp theo bản năng.</p>
            <ul class="list-disc pl-5 space-y-1">
            ...
            <p class="font-semibold text-brand-accent mt-2">Kết quả: Hiện tại cố ý cải sửa nhân quả chuyển thành nghiệp ác, sẽ nhận lãnh quả ác.</p>
          </div>

          <div class="border-l-4 border-brand-primary pl-4 py-2">
            <p class="font-bold text-brand-accent">Trường hợp B: Trong môi trường CÓ luân lý</p>
            <p class="mb-2">Ý chí chế ngự được dục vọng, thường hành động tạo nghiệp thiện.</p>
            <ul class="list-disc pl-5 space-y-1">
            ...
            <p class="font-semibold text-brand-accent mt-2">Kết quả: Luôn ý thức cải sửa nhân quả chuyển thành nghiệp thiện thì sẽ giảm nghiệp ác nhận được quả thiện.</p>
          </div>
        </div>
      </div>

      <div>
        <h4 class="font-bold text-lg text-text-secondary">3. Trời Dục giới</h4>
        <p>Ngoài ý chí còn có học vị, kiến thức, kinh nghiệm,… tâm hướng thiện, sống "tri túc thiểu dục", chọn luân lý làm thước đo.</p>
        <p class="mt-2 italic">Ví dụ: Nhà bác học phát minh khoa học; nhà giáo tận tâm giảng dạy; ngành y dược cứu chữa bệnh nhân; nhà báo đăng tin chuẩn xác; nhà hảo tâm bố thí giúp đỡ…</p>
        <p class="mt-2 font-semibold text-brand-accent">Kết quả: Quả đã tốt nay cải sửa chuyển thành quả tốt hơn, sẽ tiến hóa lên cao hơn.</p>

        <div class="bg-brand-primary/5 p-4 rounded-lg mt-4 border border-brand-primary/20">
          <p class="font-bold text-brand-accent mb-1">⚠️ Thực trạng đáng tiếc thời đại ngày nay:</p>
          <p>Vật chất ngút trời, ngũ dục lung lạc ý chí. Nhiều người chuyển mục đích "mình vì mọi người" thành "mọi người vì mình". Kiến thức, kinh nghiệm bị thương mại hóa. Đã có quả tốt nay cải sửa chuyển thành quả xấu ác, sẽ rơi xuống bốn đường ác. Thật đáng tiếc!</p>
        </div>
      </div>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
      <div>
        <h3 class="text-xl font-bold text-brand-accent mb-3 bg-brand-primary/5 inline-block px-4 py-1 rounded-lg">B. CÕI TRỜI SẮC GIỚI</h3>
        <p class="mb-2">Quyết tâm bỏ ác hướng thiện, tu thiền định để làm chủ nghiệp, thăng hoa lên cõi Sắc.</p>
        <ul class="list-disc pl-5 space-y-2">
        ...
        <p class="font-semibold mt-3">Đặc điểm Nghiệp:</p>
        <p>Tu thiền định tâm nhất niệm, làm chủ được nghiệp… cải sửa nhân quả khác thời của thọ chuyển thành nghiệp hoàn toàn thiện.</p>
      </div>

      <div>
        <h3 class="text-xl font-bold text-brand-accent mb-3 bg-brand-primary/5 inline-block px-4 py-1 rounded-lg">C. CÕI TRỜI VÔ SẮC GIỚI</h3>
        <p class="mb-2">Dùng định lực kỹ lâu sâu thăng hoa lên Tứ thiền sắc giới và các tầng Vô sắc.</p>
        <ul class="list-disc pl-5 space-y-2">
        ...
        <p class="font-semibold mt-3">Đặc điểm Nghiệp:</p>
        <p>Sống tự tại "gió bát phong không động tới" nên nghĩ rằng mình đã hoàn toàn "bất lạc nhân quả và dứt nghiệp".</p>
      </div>
    </div>

    <div class="my-10 border-t border-dashed border-brand-primary/30 opacity-50 w-2/3 mx-auto"></div>

    <h2 id="bat-muoi-nhan-qua" class="text-2xl font-bold text-brand-accent mt-10 border-b-2 border-brand-primary/20 pb-2">V. SỰ THẬT VỀ "BẤT MUỘI NHÂN QUẢ" VÀ TẬN DIỆT NGHIỆP</h2>
    
    <h3 class="text-xl font-bold text-brand-accent mt-6 mb-2">1. Bất lạc nhân quả vs. Bất muội nhân quả</h3>
    ...
    <p class="font-semibold text-text-secondary">Chỉ có tâm "vô niệm" mới "bất muội nhân quả và phi nghiệp".</p>

    <h3 class="text-xl font-bold text-brand-accent mt-8 mb-4">2. Sự chứng ngộ của Tứ Thánh</h3>
    
    <div class="space-y-6">
      <div class="border border-brand-primary/20 rounded-xl overflow-hidden">
        <div class="bg-brand-primary/5 p-3 font-bold text-lg text-text-primary">a. Nhập lưu (Tu-đà-hoàn)</div>
        <div class="p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <p class="font-bold text-brand-accent mb-1">Thánh chứng:</p>
          ...
          <div>
            <p class="font-bold text-brand-accent mb-1">Lầm lẫn của phàm phu:</p>
      ...
      <div class="border border-brand-primary/20 rounded-xl overflow-hidden">
        <div class="bg-brand-primary/5 p-3 font-bold text-lg text-text-primary">b. Nhất vãng lai (Tư-đà-hàm)</div>
        <div class="p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <p class="font-bold text-brand-accent mb-1">Thánh chứng:</p>
      ...
      <div class="border border-brand-primary/20 rounded-xl overflow-hidden">
        <div class="bg-brand-primary/5 p-3 font-bold text-lg text-text-primary">c. Bất lai (A-na-hàm)</div>
        <div class="p-4 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            <p class="font-bold text-brand-accent mb-1">Thánh chứng:</p>
      ...
      <div class="border border-brand-primary/20 rounded-xl overflow-hidden">
        <div class="bg-brand-primary/5 p-3 font-bold text-lg text-text-primary">d. A-la-hán</div>
        <div class="p-4">
          <p class="font-bold text-brand-accent mb-1">Thánh chứng:</p>
    ...
    <h3 class="text-xl font-bold text-brand-accent mt-8 mb-4">3. Sự chứng ngộ của Ba Bậc Tam Tôn</h3>
    <ul class="list-disc pl-5 space-y-2">
    ...
    <h2 id="tong-ket" class="text-2xl font-bold text-brand-accent mt-10 border-b-2 border-brand-primary/20 pb-2">VI. TỔNG KẾT BÀI GIẢNG</h2>
    <ul class="list-none pl-0 space-y-4" style="list-style-type: none;">
      <li class="bg-brand-primary/5 p-4 rounded-xl">
        <strong class="text-brand-accent text-lg">Bản chất Nhân quả:</strong> Nhân quả đồng thời là dòng chuyển biến tự nhiên làm nền tảng duyên khởi nhân quả khác thời. Tùy nhận thức mà chúng sanh cải sửa thành nghiệp thiện hoặc ác.
      </li>
      <li class="bg-brand-primary/5 p-4 rounded-xl">
        <strong class="text-brand-accent text-lg">Nguyên lý chuyển nghiệp:</strong> Thay đổi nhận thức ngay trong hiện tại. <em>"Những gì ở quá khứ được cải sửa ngay hiện tại, những gì ở tương lai đều nằm ngay hạt giống hiện tại".</em>
      </li>
      <li class="bg-brand-primary/5 p-4 rounded-xl">
        <strong class="text-brand-accent text-lg">Nguyên lý dứt nghiệp:</strong> Khi tâm vô niệm, nhận lại Chân tâm, lặng lẽ thấy rõ tiến trình ngũ uẩn diễn biến như thế nào nhận như thế nấy.
      </li>
    </ul>

    <div class="my-10 border-t border-dashed border-brand-primary/30 opacity-50 w-2/3 mx-auto"></div>

    <h2 id="thi-du" class="text-2xl font-bold text-brand-accent mt-10 border-b-2 border-brand-primary/20 pb-2">VII. THÍ DỤ TRỰC QUAN VỀ NHÂN QUẢ VÀ NGHIỆP TRÊN NỀN TẢNG "TÂM"</h2>
    
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
      <div class="border border-brand-primary/20 rounded-xl p-5">
        <h3 class="font-bold text-lg text-text-secondary mb-3">Thí dụ 1: Hành động vô ý đạp con vật</h3>
        <p class="mb-3">Vô ý đạp nhầm con rắn mối chết (đây là hành động nhân quả, ví như <strong>2x2=4</strong>).</p>
        <ul class="space-y-3">
      ...
      <div class="border border-brand-primary/20 rounded-xl p-5">
        <h3 class="font-bold text-lg text-text-secondary mb-3">Thí dụ 2: Ứng xử với người ăn xin</h3>
        <p class="mb-3">Ông lão ăn mày xin 4 ông chủ giàu có (hiện tại họ đang hưởng quả thiện):</p>
        <ul class="space-y-3">
