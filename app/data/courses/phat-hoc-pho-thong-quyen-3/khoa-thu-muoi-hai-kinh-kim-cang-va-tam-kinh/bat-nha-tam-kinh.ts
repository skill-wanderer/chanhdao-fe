...
<div class="prose prose-lg max-w-none dark:prose-invert flex flex-col items-center justify-center py-16 text-center">
  ...
  <div class="w-full max-w-2xl rounded-3xl border-2 border-primary-200 bg-primary-50/50 p-12 shadow-sm dark:border-primary-900/50 dark:bg-primary-950/20">
    <h1 class="mt-0 mb-4 text-4xl md:text-5xl font-extrabold text-primary-700 dark:text-primary-300">BÁT NHÃ TÂM KINH</h1>
    ...
    <p class="mb-8 text-base font-medium opacity-80 italic">Ngài Tam tạng Pháp sư Huyền Trang dịch chữ Phạn ra chữ Hán</p>
    ...
    <p class="mb-0 mt-1 text-base font-medium opacity-80 italic">dịch lại chữ Việt và lược giải</p>
  </div>
</div>
`

const lesson: Lesson = {
  id: 'lesson-khoa-12-bat-nha-tam-kinh',
