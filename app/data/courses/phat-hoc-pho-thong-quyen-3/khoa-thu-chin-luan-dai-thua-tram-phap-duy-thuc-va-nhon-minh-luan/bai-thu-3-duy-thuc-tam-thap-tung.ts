...
<div class="prose prose-lg max-w-none dark:prose-invert">
  <section>
    ...
    <div class="rounded-2xl border border-primary-200 bg-primary-50/70 p-5 dark:border-primary-900 dark:bg-primary-950/30">
      ...
      <p class="mb-2 font-semibold">DUY THỨC TAM THẬP TỤNG</p>
      <h2 id="bai-thu-ba-duy-thuc-tam-thap-tung" class="mt-0 text-2xl font-bold text-primary-700 dark:text-primary-300">BÀI THỨ BA - I. TÂM VƯƠNG (CÓ TÁM MÓN)</h2>
...
const lesson: Lesson = {
  ...
  title: 'Bài Thứ 3 - Duy Thức Tam Thập Tụng',
  type: 'article',
  status: 'draft',
  order: 21,
  ...
  learningMethods: [
    {
      ...
      readingContent,
      tableOfContents: [
        { id: 'bai-thu-ba-duy-thuc-tam-thap-tung', label: 'Bài Thứ Ba - I. Tâm vương (có tám món)' },
  ...
  quiz: {
    title: 'Câu hỏi ôn tập - Duy Thức Tam Thập Tụng',
    passPercentage: 70,
    questions,
  },
}
