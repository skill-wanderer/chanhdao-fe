...
Chúng tôi tự biết mình đức bạc tài sơ, chưa đủ khả năng làm việc vĩ đại này. Nhưng nếu do dự và nhún nhường mãi, rồi suốt đời cũng chẳng làm được việc gì. Chi bằng cứ cố gắng hy sinh đắp trước con đường đất, để cho các bậc có tài đức sau này sửa chữa lại, rồi cán đá và tráng nhựa.
...
Từ khóa thứ nhất đến khóa thứ tư, chúng tôi đã soạn hết Ngũ Thừa Phật giáo. Khi tín đồ đã hiểu giáo lý căn bản nói trên rồi, các khóa sau chúng tôi sẽ mở thêm bề rộng và xây dựng thêm bề cao tuần tự học về Đại cương Kinh Lăng Nghiêm, Viên Giác, Duy Thức Luận và Kim Cang, Tâm Kinh.
